<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="gradeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="专业简介" align="center" prop="instruction" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="所属专业" prop="majorId">
          <el-select v-model="form.majorId" placeholder="请输入专业名称">
            <el-option
        ...
        <el-form-item label="专业简介" prop="instruction">
          <el-input v-model="form.instruction" placeholder="请输入专业简介" />
        </el-form-item>
      </el-form>
...
import {getMajors} from "@/api/major/major";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('grade/grade/export', {
        ...this.queryParams
