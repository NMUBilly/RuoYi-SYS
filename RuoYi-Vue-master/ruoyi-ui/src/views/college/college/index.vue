<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="collegeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="学校等级" align="center" prop="level" />
      <el-table-column label="学校简介" align="center" prop="introduction" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="学校等级" prop="level">
          <el-input v-model="form.level" placeholder="请输入学校等级" />
        </el-form-item>
        <el-form-item label="学校简介" prop="introduction">
          <el-input v-model="form.introduction" placeholder="请输入学校简介" />
        </el-form-item>
      </el-form>
  ...
  data() {
    return {
      ...
      rules: {
        ...
        level: [
          { required: true, message: "学校等级不能为空", trigger: "blur" }
        ],
        introduction: [
