<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="majorList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="专业简介" align="center" prop="introduction" />
      <el-table-column label="所属院系" align="center" prop="department.name" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="所属院系" prop="departmentId">
          <el-select v-model="form.departmentId" placeholder="请输入院系名称">
            <el-option
        ...
        <el-form-item label="专业简介" prop="introduction">
          <el-input v-model="form.introduction" placeholder="请输入专业简介" />
        </el-form-item>
      </el-form>
