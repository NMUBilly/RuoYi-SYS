<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="departmentList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="院系名称" align="center" prop="name" />
      <el-table-column label="院系简介" align="center" prop="introduction" />
      <el-table-column label="所属高校" align="center" prop="college_name" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="院系简介" prop="introduction">
          <el-input v-model="form.introduction" placeholder="请输入院系简介" />
        </el-form-item>
        <el-form-item label="所属高校" prop="collegeId">
          <el-select v-model="form.collegeId" placeholder="请输入高校名称">
          <el-option
